...
export class BacktestOrchestrator {
  ...
  private convertResultsToCSV(results: FullAnalysisResult): CsvTradeRecord[] {
    const csvData: CsvTradeRecord[] = [];
...
interface PerformanceReport {
  ...
  tradeAnalysis: Record<string, number>;
