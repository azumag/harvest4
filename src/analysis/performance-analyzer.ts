...
export class PerformanceAnalyzer {
  ...
  private calculateAverageDrawdown(drawdownCurve: { drawdownPercent: number }[]): number {
  ...
  private calculateDrawdownRecoveryTime(drawdownCurve: { drawdownPercent: number }[]): number {
